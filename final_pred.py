...
class Application:
    ...
    def __init__(self):
        ...
        self.root.geometry("1000x600")  # Reduced the size of the window

        self.panel = tk.Label(self.root)
        self.panel.place(x=50, y=3, width=400, height=480)  # Adjusted size and position

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=500, y=50, width=350, height=300)  # Adjusted size and position

        self.T = tk.Label(self.root)
        self.T.place(x=30, y=5)
        self.T.config(text="Sign Language To Text Conversion", font=("Courier", 20, "bold"))  # Smaller font

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=200, y=490)

        self.T1 = tk.Label(self.root)
        self.T1.place(x=10, y=480)
        self.T1.config(text="Character :", font=("Courier", 20, "bold"))  # Smaller font
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("C:\\Users\\rydha\\Downloads\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg")
                # img_final=img_final1=img_final2=0
